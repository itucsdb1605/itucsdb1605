...
class Myconnections:
    ...
    def get_connectionlist(self):
        with dbapi2.connect(self.cp) as connection:
            ...
            query = "SELECT u1.FirstName AS Mfname, u1.LastName AS Mlname, u2.FirstName AS Ffname, u2.LastName AS Flname FROM myconnections JOIN users u1 ON myconnections.MainUserId = users.UserId JOIN users u2 ON myconnections.FriendUserId = users.UserId"
